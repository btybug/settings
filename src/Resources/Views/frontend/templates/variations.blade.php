                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            ...
                            @if($template->type=='frontlayouts')
                                <a href="{{URL('/admin/templates/variations/'.$template->id)}}" class="btn btn-xs btn-success pull-right" style="color:#fff;">Add Layout</a>
                            @else
                                <a href="{{URL('/admin/templates/variations/'.$template->id)}}" class="btn btn-xs btn-success pull-right" style="color:#fff;">Add Layout</a>
                            @endif
                        </h4>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endif
                                            ...
                                            @if($template->type =='frontlayouts')
                                                <a href="/admin/templates/settings-live-layout/{{$variation_data->id}}" class="btn btn-default btn-warning btn-xs">&nbsp;<i class="fa fa-cog"></i>&nbsp;</a>
                                            @else
                                                <a href="/admin/templates/settings-live/{{$variation_data->id}}" class="btn btn-default btn-warning btn-xs">&nbsp;<i class="fa fa-cog"></i>&nbsp;</a>
                                            @endif
