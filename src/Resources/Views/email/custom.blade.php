...
<div class="container-fluid p-0 m-t-10">
  ...
  <div class="panel panel-default" >
    <div class="panel-heading bg-black-darker text-white">Email Groups<a data-toggle="collapse" href="#addnewGroup" class="btn btn-default btn-xs pull-right"><i class="fa fa-plus" aria-hidden="true"></i></a></div>
    <div class="panel-body">
    	<div id="addnewGroup" class="collapse posrelative">
        	...
        	<div class="row">
                <div class="form-group col-xs-8 col-sm-8 p-0 p-r-5">
                    <input type="text" class="form-control" placeholder="Add New Group" data-selector="newgroup">
                </div>
    	...
    	<ul class="list-group source listwithlink" data-role="grouplist">
         @foreach($groups_list as $list)
           <li class="list-group-item"><a href="/admin/settings/email/custom/{!! $list->id !!}">  {!! $list->name !!} </a><span class="listtool"><a href="#" class="btn btn-default" data-action="editGroup" data-id="{!! $list->id !!}" data-title="{!! $list->name !!}"><i class="fa fa-pencil" aria-hidden="true"></i></a> <a href="#" class="btn btn-default" data-action="deleteGroup" data-id="{!! $list->id !!}"><i class="fa fa-trash-o" aria-hidden="true"></i></a></span></li>
         @endforeach
         </ul>
     </div>
  </div>
