    ...
    <div class="row">
        <div class="col-md-12 p-t-10">
            ...
            <ul class="nav nav-pills">
                ...
                <li role="presentation"><a href="#Twitter_Cards" aria-controls="Twitter" role="tab" data-toggle="tab">Twitter</a>
                </li>
                <li role="presentation"><a href="#Google_Analytics" aria-controls="Google_Analytics" role="tab"
                                           data-toggle="tab">Google</a></li>
                <li role="presentation"><a href="#Linkedin" aria-controls="Linkedin" role="tab" data-toggle="tab">Linkedin</a>
                </li>
                <li role="presentation"><a href="#Github" aria-controls="Github" role="tab" data-toggle="tab">GitHub</a>
                </li>
