    ...
    <div>
        <ul class="list-group">
            <li class="list-group-item">
                ...
                <div class="p-t-10">
                    <a href="http://www.robotstxt.org/robotstxt.html" target="_blank"> robots.txt file help</a>
                    (incorrectly editing your robots.txt file could block search engines from targeting your site)
                </div>

                <div class="p-t-10">
                    <a href="http://httpd.apache.org/docs/2.4/howto/htaccess.html" target="_blank"> .htaccess file
                        help</a> (.htaccess file is static and it is possible that WordPress or another plugin may
                    overwrite this file, also if you've inserted code that your web server can't understand, you can
                    disable your entire website in this way,
