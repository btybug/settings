<div class="row toolbarNav p-b-0">
    <div class="row">
        ...
        <div class="col-md-6 text-right"><a href="#"
                                            class="btn btn-default btn-default-gray">Discard</a> {!! Form::submit('Save',['class' => 'btn btn-danger btn-danger-red']) !!}
        </div>
    </div>
</div>
    ...
    <div class="col-md-7 tooleditsection">
        <div id="panelTool">
            <div class="btn-group btn-group-justified m-t-15" role="group" aria-label="..." data-tool-tab="btnpanel">
                ...
                <div class="btn-group" role="group"><a href="#extensions_size" aria-controls="toolcontent" role="tab"
                                                       data-toggle="tab" class="btn btn-default btn-dblue">Drag&Drop</a>
                </div>

                <div class="btn-group" role="group"><a href="#look_feel" aria-controls="style" role="tab"
                                                       data-toggle="tab" class="btn btn-default btn-dblue">Look&Feel</a>
                </div>
            </div>
