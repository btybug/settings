                                ...
                                <div class="row templates m-b-10">
                                    <div class="col-xs-12 p-l-0 p-r-0">
                                        @if(isset($layout->image))
                                            <img src="{!! url('resources/templates/'.$layout->type.'/'.$layout->slug. '/images/'. $layout->image)!!}"
                                                 style="height: 167px;" class="img-responsive"/>
                                        @else
                                            <img src="{!! url('resources/assets/images/template-2.png')!!}"
                                    ...
                                    <div class="col-xs-12 templates-header p-t-10 p-b-10">
                                        ...
                                        <div class="pull-right templates-buttons col-xs-6 col-sm-6 col-md-6 col-lg-6 p-r-0 text-right ">
                                            ...
                                            , {!! BBgetDateFormat($layout->created_at) !!}
                                            <a href="#" class="addons-deactivate  m-r-10"><i
                                                        class="fa fa-pencil f-s-14"></i> </a>
                                            <a href="{!! url('/admin/backend/pages-layout/settings',$layout->slug) !!}"
                                               class="addons-deactivate  m-r-10"><i class="fa fa-cog f-s-14"></i> </a>
                                            <a href="{!! url('/admin/backend/pages-layout/delete',$layout->slug) !!}"
                                               data-href="{!! url('/admin/backend/pages-layout/delete',$layout->slug) !!}"
                                               slug="#" class="addons-delete del-tpl"><i
