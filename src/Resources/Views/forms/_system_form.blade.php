			...
			<div class="col-sm-12  col-md-12">
				...
				<div class="">
					<div class="radio">
						<label class="radio_label labels">
							{!! Form::radio('error_display', 1, (isset($system['error_display']) && $system['error_display']) ? 'checked' : '') !!} True
						</label>
						<label class="radio_label labels">
							{!! Form::radio('error_display', 0, (!isset($system['error_display']) || ($system['error_display'] == 0) ) ? 'checked' : '') !!} False
						</label>
					</div>
				</div>
			  </div>
			  ...
			  <div class="form-group">
				...
				<div class="">
					<div class="radio">
						<label >
							{!! Form::radio('time_format', 'seconds', (isset($system['time_format']) && $system['time_format']== 'seconds') ? 'checked' : '') !!} HH:MM:SS
						</label>
					</div>
					<div class="radio">
						<label>
							{!! Form::radio('time_format', '24hrs', (isset($system['time_format']) && $system['time_format']== '24hrs') ? 'checked' : '') !!} HH:MM 24 Hours
						</label>
					</div>
					<div class="radio">
						<label>
							{!! Form::radio('time_format', '12hrs', (isset($system['time_format']) && $system['time_format']== '12hrs') ? 'checked' : '') !!} HH:MM 12 Hours
						</label>
					</div>
				</div>
			  </div>
