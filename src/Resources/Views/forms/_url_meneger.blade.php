...
<div class="form-group">
  ...
  <div class="col-md-6">
    <div class="input-group">
      ...
      <input id="prependedcheckbox" class="form-control" type="text" readonly value="http://avatarbugs.com/posts/?p=123">
    </div>
...
<div class="form-group">
  ...
  <div class="col-md-6">
    <div class="input-group">
      ...
      <input id="day-name"  class="form-control" type="text" readonly value="http://avatarbugs.com/2016/02/25/my-post">
    </div>
...
<div class="form-group">
  ...
  <div class="col-md-6">
    <div class="input-group">
      ...
      <input id="prependedcheckbox" class="form-control" type="text" readonly value="http://avatarbugs.com/my-post">
    </div>
...
<div class="form-group">
  ...
  <div class="col-md-6">
    <div class="input-group">
      ...
      <input id="prependedcheckbox"  class="form-control" type="text" readonly value="http://avatarbugs.com/posts/123">
    </div>
