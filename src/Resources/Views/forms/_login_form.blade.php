				  ...
				  <div class="">
					    <div class="radio">
							<label class="radio_label">
								{!! Form::radio('enable_registration', 1, (isset($system['enable_registration']) && $system['enable_registration']) ? 'checked' : '') !!} Yes
							</label>
							<label class="radio_label">
								{!! Form::radio('enable_registration', 0, (!isset($system['enable_registration']) || ($system['enable_registration'] == 0) ) ? 'checked' : '') !!} No
							</label>
						</div>
				  </div>
			  </div>
			  ...
			  <div class="form-group">
			    {!! Form::label('email_activation','Email Activation Required',['class' => 'control-label labels'])!!}
				  <div class="">
					    <div class="radio">
							<label class="radio_label">
								{!! Form::radio('email_activation', 1,(isset($system['email_activation']) && $system['email_activation']) ? 'checked' : '') !!} Yes
							</label>
							<label class="radio_label">
								{!! Form::radio('email_activation', 0, (!isset($system['email_activation']) || ($system['email_activation'] == 0) ) ? 'checked' : '') !!} No
							</label>
						</div>
				  </div>
			  </div>
			  ...
			  <div class="form-group">
			    {!! Form::label('email_on_register','Welcome email on Register',['class' => 'control-label labels'])!!}
				  <div class="">
					    <div class="radio">
							<label class="radio_label">
								{!! Form::radio('email_on_register', 1, (isset($system['email_on_register']) && $system['email_on_register']) ? 'checked' : '') !!} Yes
							</label>
							<label class="radio_label">
								{!! Form::radio('email_on_register', 0, (!isset($system['email_on_register']) || ($system['email_on_register'] == 0) ) ? 'checked' : '') !!} No
							</label>
						</div>
				  </div>
			  </div>
