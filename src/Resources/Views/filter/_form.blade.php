          ...
          <div class="field-type hide" data-type="number">
            <div class="form-group">
              ...
              <div class="form-group single-container hide">
                <input type="number" name="value_number" placeholder="Search Value" class="form-control" />
              </div>
...
$('document').ready(function () {
  ...
  $('#filters').change(function(){
    var filter = $(this).val();
    postAjax('/admin/settings/filter/filterdata',{module:$('#modules').val(),filter:filter}, function(data){
