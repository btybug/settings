        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body form-inline">
                <div class="form-group col-md-4">
                    ...
                    {!! Form::text('title',null,['class'=>'form-control','placeholder'=>'Main Navigation','required']) !!}
                </div>
                <div class="form-group col-md-4">
...
<div class="row">
    ...
    <div class="col-md-6" data-role="menuItems">
        <div class="panel panel-default">
            <div class="panel-heading bg-black-darker text-white">Menu Item
                <button type="button" class="btn btn-success btn-xs pull-right" data-action="addnew"
                        data-target="#addnewform">Add New Item
                </button>
                <button type="button" class="btn btn-warning btn-xs m-r-10 pull-right" data-Duplicate="Duplicate">
                    Duplicate Form Default
                </button>
            </div>
            <div class="panel-body">
                @if(!@$menu)
                    ...
                    <div class="row">
                        <div class="col-md-12 form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input id="addtext" name="addtext" type="text" placeholder="text"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input id="adnewclass" name="adnewclass" type="text" placeholder="Class"
                                           class="form-control input-md">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group selectpage2 hide" data-selectpage="custom-link">
                                ...
                                <div class="col-md-7">
                                    <input type="text" class="form-control" id="addcustom-link"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <button type="button" class="btn btn-success save" data-action="save"
                                            data-role="addnew">Save
                                    </button>
                                </div>
                            </div>
                        </div>
