        ...
        <div class="col-md-12">
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation"><a href="/admin/settings/backnotify" aria-controls="notifications" role="tab">Notifications
                        & Tool Tips</a></li>
                <li role="presentation"><a href="/admin/settings/backlayout" aria-controls="layout"
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-default btn-primary btn-xs"
                                   href="{{url('admin/settings/backmenu/show', [$menu->id])}}">&nbsp;<i
                                            class="fa fa-eye"></i>&nbsp;</a>
                                @if(!starts_with($menu->type,'default-'))
                                    <a class="btn btn-default btn-primary btn-xs"
                                       href="{{url('admin/settings/backmenu/update', [$menu->id])}}">&nbsp;<i
                                                class="fa fa-cog"></i>&nbsp;</a>
