@extends('layouts.admin')
  ...
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation" class="active"><a href="/admin/settings/backheader" aria-controls="header" role="tab" >Header</a></li>
    <li role="presentation"><a href="/admin/settings/backmenu" aria-controls="adminMenu" role="tab" >Admin Menus</a></li>
