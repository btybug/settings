    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation"><a href="/admin/cloud/admin-theme-settings" role="tab">Admin Theme</a></li>
                <li role="presentation" class="active"><a href="/admin/settings/backnotify"
                                                          aria-controls="notifications" role="tab">Notifications & Tool
                        Tips</a></li>
            </ul>
                        ...
                        <div class="col-sm-6">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <button class="btn btn-success alert-success" onClick="openNotyType('success')"
                                            type="button">Success
                                    </button>
                                    <button class="btn btn-info alert-info" onClick="openNotyType('info')"
                                            type="button">Info
                                    </button>
                                    <button class="btn btn-warning alert-warning" onClick="openNotyType('warning')"
                                            type="button">Warning
                                    </button>
                                    <button class="btn btn-danger alert-danger" onClick="openNotyType('danger')"
                                            type="button">Danger
                                    </button>
                                </div>
                            </div>
                                ...
                                <div class="panel-body hide">
                                    <form action="" method="POST" class="form-horizontal">
                                        ...
                                        <ul class="submit-btns">
                                            <li>
                                                <button type="submit" class="btn btn-primary btn-md" name="save">Save
                                                </button>
                                            </li>
                                            <li>
                                                <button type="submit" class="btn btn-primary btn-md" name="save">Save
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-xs-4"><a href="javascript:;" onClick="openNoty('left', 'top')"
                                                                 class="btn btn-block p-t-30 p-b-30 m-b-10  bg-silver-darker"></a>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-4"><a href="javascript:;"
                                                                 onClick="openNoty('left', 'center')"
                                                                 class="btn btn-block p-t-30 p-b-30 m-b-10 bg-silver-darker"></a>
                                        </div>
                                        <div class="col-xs-4"><a
                                                    class="btn btn-block p-t-30 p-b-30 m-b-10 bg-green"></a></div>
                                        <div class="col-xs-4"><a href="javascript:;"
                                                                 onClick="openNoty('right', 'center')"
                                                                 class="btn btn-block p-t-30 p-b-30 m-b-10 bg-silver-darker"></a>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-4"><a href="javascript:;"
                                                                 onClick="openNoty('left', 'bottom')"
                                                                 class="btn btn-block p-t-30 p-b-30 m-b-10 bg-silver-darker"></a>
                                        </div>
                                        <div class="col-xs-4"><a href="javascript:;"
                                                                 onClick="openNoty('center', 'bottom')"
                                                                 class="btn btn-block p-t-30 p-b-30 m-b-10 bg-silver-darker"></a>
                                        </div>
                                        <div class="col-xs-4"><a href="javascript:;"
                                                                 onClick="openNoty('right', 'bottom')"
                                                                 class="btn btn-block p-t-30 p-b-30 m-b-10 bg-silver-darker"></a>
                                        </div>
                                    </div>
                                </div>
