...
<div class="col-md-10 p-0">
  <div class="panel panel-default" data-sortable-id="ui-typography-7">
    <div class="panel-heading bg-black-darker text-white">Notification Settings For &nbsp; <b>{!! $model->name!!}</b></div>
    <div class="panel-body p-5"> {!! Form::hidden('id',$model->id) !!}
      <table class="table borderless m-0">
      
        <tr>
          <td width="18%"><div  class="p-5">Active</div></td>
          <td width="82%">
        ...
        <tr>
          <td><div class="p-t-5">Type</div></td>
          <td>
        ...
        <tr>
          <td width="18%"><div class="p-5">Sender</div></td>
          <td width="82%">
        ...
        <tr>
          <td width="18%"><div  class="p-5">Receiver</div></td>
          <td width="82%">
             
              <input name="receivers" class="form-control hide" data-tagit="tagit" type="text" value="{!! $model->receivers !!}">
           
            </td>
        </tr>

        <tr>
          <td width="18%"><div  class="p-5">Send Email</div></td>
          <td width="82%">{!! Form::checkbox('send_mail', 1, null,['class'=>'chkbx','data-on-text'=>'Yes','data-off-text'=>'No','data-off-color'=>'danger']) !!}</td>
        </tr>

        
        <tr>
          <td width="18%"><div  class="p-5">Email Template</div></td>
          <td width="82%">
         ...
         <tr>
          <td width="18%"><div  class="p-5">Associate To Event</div></td>
          <td width="82%">
        ...
        <tr>
          <td width="18%"><div  class="p-5">Choose Event</div></td>
          <td width="82%">
        ...
        <tr>
          <td width="18%"><div class="p-5">Text</div></td>
